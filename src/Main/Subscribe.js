...
const Subscribe = () => {
    return (
        <div className='bg-black text-white md:grid md:grid-cols-2 justify-between '>
            <div className='w-8/12 ml-16 md:ml-56 pt-12 md:pt-0 md:mt-28 pb-5 md:pb-0'>
                <div>
                ...
                <button className='bg-white text-black font-bold rounded-full py-4 px-8 ml-16 md:ml-0 mt-10'>SUBSCRIBE</button>
            </div>
            <div>
