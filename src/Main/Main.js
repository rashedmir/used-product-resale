            ...
            <div className='relative'>
                <div className='absolute w-full'>
                    ...
                    <div className='text-white mt-64 mx-44'>
                        ...
                        <div className='mt-5 font-bold font1'>
                            <button className='bg-white rounded-full mr-10 text-black py-5 px-6'>BUY WATCH</button>
                            <button className='bg-white rounded-full mr-10 text-black py-5 px-6'>SELL WATCH</button>
                        </div>
