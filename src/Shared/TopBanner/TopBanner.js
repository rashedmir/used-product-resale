      ...
      {user ? (
        <>
          <div className="bg-black">
            {user.photoURL == "admin" ? (
              <>
                <div className="font1 md:px-0 px-5 text-xs md:text-sm py-3 md:mx-48 flex justify-between text-white">
                  ...
                  <div className="flex items-center">
                    ...
                    <Link to="">
                      <h2 className="mr-2">All Seller</h2>
                    </Link>
                    ...
                    <button
                      ...
                      className="my-0 ml-10 text-white"
                    >
                      Log Out
                    </button>
                    ...
                    <div className="font1 md:px-0 px-5 text-xs md:text-sm py-3 md:mx-48 flex justify-between text-white">
                      ...
                      <div className="flex items-center">
                        ...
                        <Link to="/homepage/addproducts">
                          <h2 className="mr-2">Add Products</h2>
                        </Link>
                        <h2 className="mr-2">|</h2>
                        <Link to="/homepage/myproduct">
                          <h2>My Products</h2>
                        </Link>
                        <button
                          onClick={handleLogOut}
                  ...
                  <>
                    <div className="font1 md:px-0 px-5 text-xs md:text-sm py-3 md:mx-48 flex justify-between text-white">
                      ...
                      <div className="flex items-center">
                        ...
                        <h2 className="mr-5">100% Certified Authentic</h2>
                        <Link to="/homepage/myorders">
                          <h2 className="mr-2">My Orders</h2>
                        </Link>
                        <button
                          onClick={handleLogOut}
                          className="my-0 ml-10 text-white"
          ...
          <div className="bg-black">
            <div className="font1 md:px-0 px-5 text-xs md:text-sm py-3 md:mx-48 flex justify-between text-white">
              ...
              <div className="flex">
                ...
                <img
                  className="w-4 h-4 md:h-5 md:w-5 mx-2"
                  src={certified}
                  alt=""
                />
                <h2 className="mr-5">100% Certified Authentic</h2>
