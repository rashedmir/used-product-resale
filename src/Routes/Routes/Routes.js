...
export const routes = createBrowserRouter([
  {
    ...
    loader: () =>
      fetch(
        `https://b612-used-products-resale-server-side-rashedmir.vercel.app/watches`
      ),
  },
  {
    path: "/homepage",
    ...
    children: [
      ...
      },
      {
        ...
        loader: (params) =>
          fetch(
            `https://b612-used-products-resale-server-side-rashedmir.vercel.app/watches/${params.id}`
          ),
      },
      {
