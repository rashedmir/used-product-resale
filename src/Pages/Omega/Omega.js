    ...
    <div>
      <div className="md:grid md:grid-cols-2">
        <div className="bg-black">
          <img
            className="w-8/12 ml-16 md:ml-36 md:pl-28 pt-0"
            src="https://i.ibb.co/qs6HwMS/omega.jpg"
            alt=""
          />
        </div>
        <div className="bg-black">
          ...
          <h1 className="text-justify font1 text-sm text-white pb-8 md:p-0 px-8 md:px-36">
            With a rich history dating back to 1848, Omega is one of the world's
            oldest and most widely respected luxury watch manufacturers. The
            iconic Swiss timepiece company produces everything from elegant
            dress watches to technologically advanced sports chronographs, and
            Omega watches have been worn by everyone from actors in films to
