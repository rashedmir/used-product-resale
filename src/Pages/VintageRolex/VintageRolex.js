                                        ...
                                        </a>
                                        {
                                            ...
                                            user?.photoURL == "seller" ? (<div><p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{watch.details.slice(0, 100)}...</p>
                                                <Link to='/'><button disabled className='bg-red-200 w-full text-white ml-0 rounded p-3'>Book Now</button></Link></div>) : (<div><p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{watch.details.slice(0, 100)}...</p>
                                                    <Link to='/homepage/private/vintagerolex'><button onClick={() => { setShowModal(true); setModalObject(watch) }} className='bg-gray-700 w-full text-white ml-0 rounded p-3'>Book Now</button></Link></div>)
                                        }
                                                    ...
                                                    <div >
                                                        ...
                                                        <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                                            ...
                                                            <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                                                                ...
                                                                >
                                                                    <span onClick={() => setShowModal(false)} className="bg-transparent text-black opacity-5 h-6 w-6 text-2xl block outline-none focus:outline-none">
                                                                        ×
                                                                    </span>
                                                                </button>
                                                            </div>
