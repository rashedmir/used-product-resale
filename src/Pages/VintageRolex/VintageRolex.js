    ...
    <div>
      <div className="md:grid md:grid-cols-2">
        <div className="bg-black">
          <img
            className="pr-4 md:pr-0 md:ml-36 md:h-96 md:pl-28 pt-0"
            src="https://cdn4.ethoswatches.com/the-watch-guide/wp-content/uploads/2017/11/post1-1.jpg"
            alt=""
          />
        </div>
        <div className="bg-black">
          ...
          <h1 className="text-justify font1 text-sm text-white px-8 md:px-36 pb-8 md:pb-0">
            Vintage Rolex watches are some of the most valuable and desirable
            timepieces in the entire world. The market has seen values surge
            with Phillips, Sotheby's, and Christie's auction houses reporting
            record prices on historic watches. For example, a Rolex Daytona Paul
            Newman sold for over $17 million in 2017. All of our vintage
            timepieces are 100% genuine and come with a lifetime authenticity
            guarantee.
          </h1>
        </div>
      </div>
                            ...
                            <div>
                              ...
                              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                ...
                                <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                                  ...
                                  <button
                                    className="p-1 ml-auto bg-red-200 border-0 text-black opacity-5 float-right text-3xl leading-none font-semibold outline-none focus:outline-none"
